  ...
  function init() {
    ...
    for (var i = 0; i < NUM_OF_CUBES; i++) {
      ...
      if(Math.round(Math.random()) == 0)
        chosenColor = new THREE.Color("rgb(192,192,192)");
      else
        chosenColor = new THREE.Color("rgb(24,24,254)");

      objects[i] = new THREE.Mesh( geometry, new THREE.MeshBasicMaterial( { color: chosenColor, opacity: 1, transparent: true, depthWrite: false } ) );
